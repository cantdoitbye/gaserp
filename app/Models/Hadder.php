...
class Hadder extends Model
{
   use HasFactory;
    ...
    /**
     * Get the measurement type for this Ladder job
     */
    ...
    {
        return [
            'main_ladder' => 'Main Ladder',
            'sub_ladder' => 'Sub Ladder',
            'cross_ladder' => 'Cross Ladder',
            'connecting_ladder' => 'Connecting Ladder',
            'distribution_ladder' => 'Distribution Ladder'
        ];
    }
    ...
    {
        return [
            'ladder_standard' => 'Ladder Standard',

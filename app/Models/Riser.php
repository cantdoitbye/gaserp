...
class Riser extends Model
{
   use HasFactory;
    ...
    /**
     * Get the measurement type for this Riser job
     */
    ...
    public static function getAreaOptions()
    {
        return [
            ...
            'sub_riser' => 'Sub Riser',
            'approach_riser' => 'Approach Riser',
            'building_riser' => 'Building Riser',
            'vertical_riser' => 'Vertical Riser'
        ];
    }
    ...
    {
        return [
            'riser_standard' => 'Riser Standard',
            'approach_connection' => 'Approach Connection', 
            'main_line_connection' => 'Main Line Connection',
            'building_connection' => 'Building Connection'
        ];
    }

...
<div class="main-container">
    ...
    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="agreement_date" class="form-control datepicker-input @error('agreement_date') is-invalid @enderror" value="{{ old('agreement_date', $png->agreement_date ? $png->agreement_date->format('Y-m-d') : '') }}" placeholder="dd-mm-yyyy">
            ...
            <div id="plb_fields" class="conditional-fields" style="display: {{ ($png->plb_name || $png->plb_date) ? 'block' : 'none' }};">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="plb_date" class="form-control datepicker-input @error('plb_date') is-invalid @enderror" 
                               value="{{ old('plb_date', $png->plb_date ? $png->plb_date->format('Y-m-d') : '') }}" placeholder="dd-mm-yyyy">
                        @error('plb_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div id="step-3" class="step-content">
            ...
            <div id="pdt_fields" class="conditional-fields" style="display: {{ ($png->pdt_date || $png->pdt_tpi) ? 'block' : 'none' }};">
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label">PPT Date</label>
                        <input type="text" name="pdt_date" class="form-control datepicker-input @error('pdt_date') is-invalid @enderror" 
                               value="{{ old('pdt_date', $png->pdt_date ? $png->pdt_date->format('Y-m-d') : '') }}" placeholder="dd-mm-yyyy">
                        @error('pdt_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div id="gc_fields" class="conditional-fields" style="display: {{ ($png->gc_date || $png->gc_tpi) ? 'block' : 'none' }};">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="gc_date" class="form-control datepicker-input @error('gc_date') is-invalid @enderror" 
                               value="{{ old('gc_date', $png->gc_date ? $png->gc_date->format('Y-m-d') : '') }}" placeholder="dd-mm-yyyy">
                        @error('gc_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div id="step-5" class="step-content">
            ...
            <div id="mmt_fields" class="conditional-fields" style="display: {{ ($png->mmt_date || $png->mmt_tpi) ? 'block' : 'none' }};">
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label">MMT Date</label>
                        <input type="text" name="mmt_date" class="form-control datepicker-input @error('mmt_date') is-invalid @enderror" 
                               value="{{ old('mmt_date', $png->mmt_date ? $png->mmt_date->format('Y-m-d') : '') }}" placeholder="dd-mm-yyyy">
                        @error('mmt_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div id="conversion_done_fields" class="conditional-fields" style="display: {{ old('conversion_status', $png->conversion_status) == 'done' ? 'block' : 'none' }};">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="conversion_date" class="form-control datepicker-input @error('conversion_date') is-invalid @enderror" 
                               value="{{ old('conversion_date', $png->conversion_date ? $png->conversion_date->format('Y-m-d') : '') }}" placeholder="dd-mm-yyyy">
                        @error('conversion_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div id="files-documents" class="tab-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="form-file-info">Accepted formats: PDF, JPG, PNG (max: 7MB) - Upload new file to replace existing</div>
                            @error('scan_copy')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            <div class="form-file-info">Multiple files allowed. Accepted formats: PDF, DOC, DOCX, JPG, PNG (max: 7MB each) - New files will be added to existing</div>

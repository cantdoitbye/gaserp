            ...
            <div class="import-instructions">
                ...
                <div class="instruction-content">
                    ...
                    <ul>
                        ...
                        <li><strong>Plan Type:</strong> Must be one of: apartment, bungalow, rowhouse, commercial, individual, farmhouse</li>
            ...
            <div class="data-validation-guide">
                ...
                <div class="validation-grid">
                    ...
                    <div class="validation-category">
                        ...
                        <div class="value-list">
                            <span class="value-item valid">apartment</span>
                            <span class="value-item valid">bungalow</span>
                            <span class="value-item valid">rowhouse</span>
                            <span class="value-item valid">commercial</span>
                            <span class="value-item valid">individual</span>
                            <span class="value-item valid">farmhouse</span>
                        </div>

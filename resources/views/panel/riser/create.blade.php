...
<div class="main-container">
    ...
    <h1 class="page-title">Add New Riser Job</h1>

    <div class="form-card">
        <div class="form-header">
            New Riser Job Order Details
        </div>
        <div class="form-body">
                ...
                <div id="files-documents" class="tab-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="form-file-info">Accepted formats: PDF, JPG, Riser (max: 5MB)</div>
                            @error('scan_copy')
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            <div class="form-file-info">Multiple files allowed. Accepted formats: PDF, DOC, DOCX, JPG, Riser (max: 5MB each)</div>
            ...
            <form action="{{ route('riser.store') }}" method="POST" enctype="multipart/form-data" onsubmit="debugFormSubmission(event)">
                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="riser_type" id="riser_type" class="form-control @error('riser_type') is-invalid @enderror" onchange="loadMeasurementTypes()" required>
                                ...
                                @foreach(\App\Models\PngMeasurementType::getRiserTypeOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('riser_type') == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">Create Riser Job</button>
                </div>
            </form>
        </div>
    </div>

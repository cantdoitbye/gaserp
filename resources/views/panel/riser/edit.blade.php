...
<div class="main-container">
    ...
    <h1 class="page-title">Edit Riser Job</h1>

    <div class="form-card">
        <div class="form-header">
            Edit Riser Job Order Details - #{{ $riser->id }}
        </div>
        <div class="form-body">
            ...
            <form action="{{ route('riser.update', $riser->id) }}" method="POST" enctype="multipart/form-data" onsubmit="debugFormSubmission(event)">
                @csrf
                @method('PUT')
                ...
                <div id="basic-info" class="tab-content active">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="agreement_date" class="form-control @error('agreement_date') is-invalid @enderror" value="{{ old('agreement_date', $riser->agreement_date ? $riser->agreement_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_no" class="form-control @error('customer_no') is-invalid @enderror" value="{{ old('customer_no', $riser->customer_no) }}">
                            @error('customer_no')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="service_order_no" class="form-control @error('service_order_no') is-invalid @enderror" value="{{ old('service_order_no', $riser->service_order_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="application_no" class="form-control @error('application_no') is-invalid @enderror" value="{{ old('application_no', $riser->application_no) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_name" class="form-control @error('customer_name') is-invalid @enderror" value="{{ old('customer_name', $riser->customer_name) }}" required>
                            @error('customer_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_no" class="form-control @error('contact_no') is-invalid @enderror" value="{{ old('contact_no', $riser->contact_no) }}">
                            @error('contact_no')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea name="address" rows="3" class="form-control @error('address') is-invalid @enderror">{{ old('address', $riser->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea name="area" rows="2" class="form-control @error('area') is-invalid @enderror">{{ old('area', $riser->area) }}</textarea>
                            ...
                            {{-- <select name="area" class="form-control @error('area') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Riser::getAreaOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('area', $riser->area) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select> --}}
                        ...
                        <div class="form-group">
                            ...
                            <select name="scheme" class="form-control @error('scheme') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Riser::getSchemeOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('scheme', $riser->scheme) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div id="technical-details" class="tab-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="connections_status" class="form-control @error('connections_status') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Riser::getConnectionsStatusOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('connections_status', $riser->connections_status) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="plumber_name" class="form-control @error('plumber_name') is-invalid @enderror" value="{{ old('plumber_name', $riser->plb_name) }}">
                            @error('plumber_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="plumbing_date" class="form-control @error('plumbing_date') is-invalid @enderror" value="{{ old('plumbing_date', $riser->plb_date ? $riser->plb_date->format('Y-m-d') : '') }}">
                            @error('plumbing_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="pdt_date" class="form-control @error('pdt_date') is-invalid @enderror" value="{{ old('pdt_date', $riser->pdt_date ? $riser->pdt_date->format('Y-m-d') : '') }}">
                            @error('pdt_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="pdt_witness_by" class="form-control @error('pdt_witness_by') is-invalid @enderror" value="{{ old('pdt_witness_by', $riser->pdt_witness_by) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="ground_connections_date" class="form-control @error('ground_connections_date') is-invalid @enderror" value="{{ old('ground_connections_date', $riser->ground_connections_date ? $riser->ground_connections_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="ground_connections_witness_by" class="form-control @error('ground_connections_witness_by') is-invalid @enderror" value="{{ old('ground_connections_witness_by', $riser->ground_connections_witness_by) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="isolation_name" class="form-control @error('isolation_name') is-invalid @enderror" value="{{ old('isolation_name', $riser->isolation_name) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="mmt_date" class="form-control @error('mmt_date') is-invalid @enderror" value="{{ old('mmt_date', $riser->mmt_date ? $riser->mmt_date->format('Y-m-d') : '') }}">
                            @error('mmt_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mmt_witness_by" class="form-control @error('mmt_witness_by') is-invalid @enderror" value="{{ old('mmt_witness_by', $riser->mmt_witness_by) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="conversion_technician_name" class="form-control @error('conversion_technician_name') is-invalid @enderror" value="{{ old('conversion_technician_name', $riser->conversion_technician_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="conversion_date" class="form-control @error('conversion_date') is-invalid @enderror" value="{{ old('conversion_date', $riser->conversion_date ? $riser->conversion_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="conversion_status" class="form-control @error('conversion_status') is-invalid @enderror">
                                <option value="">Select Status</option>
                                @foreach(\App\Models\Riser::getConversionStatusOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('conversion_status', $riser->conversion_status) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="report_submission_date" class="form-control @error('report_submission_date') is-invalid @enderror" value="{{ old('report_submission_date', $riser->report_submission_date ? $riser->report_submission_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="meter_number" class="form-control @error('meter_number') is-invalid @enderror" value="{{ old('meter_number', $riser->meter_number) }}">
                            @error('meter_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ra_bill_no" class="form-control @error('ra_bill_no') is-invalid @enderror" value="{{ old('ra_bill_no', $riser->ra_bill_no) }}">
                            @error('ra_bill_no')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            <textarea name="remarks" rows="3" class="form-control @error('remarks') is-invalid @enderror">{{ old('remarks', $riser->remarks) }}</textarea>
                            @error('remarks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div id="measurements" class="tab-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">Riser Type <span class="required">*</span></label>
                            <select name="riser_type" id="riser_type" class="form-control @error('riser_type') is-invalid @enderror" onchange="loadMeasurementTypes()" required>
                                <option value="">Select Riser Type</option>
                                @foreach(\App\Models\PngMeasurementType::getRiserTypeOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('riser_type', $riser->riser_type) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="riser_measurement_type_id" id="measurement_type" class="form-control @error('riser_measurement_type_id') is-invalid @enderror" onchange="loadMeasurementFields()" required>
                                <option value="">Select Measurement Type</option>
                                @if($riser->measurementType)
                                    <option value="{{ $riser->measurementType->id }}" selected>
                                        {{ $riser->measurementType->name }}
                                    </option>
                                @endif
                            </select>
                            @error('riser_measurement_type_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>

                    <div id="measurement-fields-container" style="{{ $riser->measurements_data ? 'display: block;' : 'display: none;' }}">
                        <!-- Dynamic measurement fields will be loaded here -->
                        @if($riser->measurements_data && $riser->measurementType)
                            <div class="measurement-category" id="current-measurements-display">
                                ...
                                <div class="form-row">
                                    @php
                                        ...
                                        foreach($riser->measurements_data as $key => $value) {
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <button type="button" class="btn btn-info" onclick="window.open('{{ route('riser-measurement-types.index') }}', '_blank')">
                                <i class="fas fa-cog"></i> Manage Measurement Types
                            </button>
                            @if($riser->measurements_data)
                ...
                <div id="files-documents" class="tab-content">
                    ...
                    <div class="documents-grid">
                        ...
                        <div class="document-section">
                            ...
                            @if($riser->job_cards_paths && count($riser->job_cards_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($riser->job_cards_paths as $file)
                            ...
                            <div class="document-upload-area">
                                <input type="file" name="job_cards[]" id="job_cards" class="file-input" multiple accept=".pdf,.jpg,.jpeg,.riser,.doc,.docx">
                            ...
                            <div class="document-info">
                                <small class="text-muted">Accepted formats: PDF, JPG, Riser, DOC, DOCX (max: 5MB each)</small>
                            </div>
                        </div>
                        ...
                        <div class="document-section">
                            ...
                            @if($riser->autocad_dwg_paths && count($riser->autocad_dwg_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($riser->autocad_dwg_paths as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                        ...
                        <div class="document-section">
                            ...
                            @if($riser->site_visit_reports_paths && count($riser->site_visit_reports_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($riser->site_visit_reports_paths as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                            ...
                            <div class="document-upload-area">
                                <input type="file" name="site_visit_reports[]" id="site_visit_reports" class="file-input" multiple accept=".pdf,.jpg,.jpeg,.riser,.doc,.docx">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            @if($riser->scan_copy_path)
                                <div class="existing-file">
                                    <a href="{{ Storage::url($riser->scan_copy_path) }}" target="_blank">View Current Scan Copy</a>
                                </div>
                            @endif
                            <input type="file" name="scan_copy" class="form-control-file @error('scan_copy') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.riser">
                            <div class="form-file-info">Accepted formats: PDF, JPG, Riser (max: 5MB) - Upload new file to replace existing</div>
                            @error('scan_copy')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if($riser->certificate_path)
                                <div class="existing-file">
                                    <a href="{{ Storage::url($riser->certificate_path) }}" target="_blank">View Current Certificate</a>
                                </div>
                            @endif
                            <input type="file" name="certificate" class="form-control-file @error('certificate') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.riser">
                            <div class="form-file-info">Accepted formats: PDF, JPG, Riser (max: 5MB) - Upload new file to replace existing</div>
                            @error('certificate')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            @if($riser->other_documents_paths && count($riser->other_documents_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($riser->other_documents_paths as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                            ...
                            @endif
                            <input type="file" name="other_documents[]" class="form-control-file @error('other_documents.*') is-invalid @enderror" multiple accept=".pdf,.jpg,.jpeg,.riser,.doc,.docx">
                            <div class="form-file-info">Multiple files allowed. Accepted formats: PDF, DOC, DOCX, JPG, Riser (max: 5MB each) - New files will be added to existing</div>
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            @if($riser->additional_documents && count($riser->additional_documents) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($riser->additional_documents as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                            ...
                            @endif
                            <input type="file" name="additional_documents[]" class="form-control-file @error('additional_documents.*') is-invalid @enderror" multiple accept=".pdf,.jpg,.jpeg,.riser,.doc,.docx">
                            <div class="form-file-info">Multiple files allowed. Accepted formats: PDF, DOC, DOCX, JPG, Riser (max: 5MB each) - New files will be added to existing</div>
                ...
                <div class="form-actions">
                    <a href="{{ route('riser.index') }}" class="btn btn-secondary">Cancel</a>
                    <a href="{{ route('riser.show', $riser->id) }}" class="btn btn-info">View Details</a>
                    <button type="submit" class="btn btn-primary">Update Riser Job</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    const existingMeasurements = @json($riser->measurements_data ?? []);
    ...
    function loadMeasurementTypes() {
        const riserType = document.getElementById('riser_type').value;
        const measurementTypeSelect = document.getElementById('measurement_type');
        const currentMeasurementTypeId = '{{ $riser->riser_measurement_type_id }}';
        ...
        // Fetch measurement types for selected Riser type
        fetch(`{{ route('riser.measurement-types.by-type') }}?riser_type=${riserType}`)
    ...
    function loadMeasurementFields() {
        ...
        fetch(`{{ url('admin/riser-measurement-types') }}/${measurementTypeId}/fields`)
            .then(response => response.json())
            .then(data => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Load measurement types if Riser type is already selected
        const riserType = document.getElementById('riser_type').value;
        if (riserType) {
    ...
    function resetToCurrentMeasurements() {
        const container = document.getElementById('measurement-fields-container');
        const currentMeasurements = @json($riser->measurements_data ?? []);

...
<div class="main-container">
    ...
    <div class="financial-dashboard">
        ...
        <div class="chart-placeholder">
            <i class="fas fa-chart-area" style="font-size: 48px; color: #dee2e6; margin-right: 15px;"></i>
    ...
    <div id="dashboard" class="tab-content">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-bottom: 30px;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 25px; border-radius: 12px; text-align: center;">
                <div style="font-size: 28px; font-weight: 700; margin-bottom: 8px;">₹1,25,75,000</div>
                <div style="opacity: 0.9; font-size: 16px;">Total Revenue (YTD)</div>
                <div style="font-size: 14px; margin-top: 8px; opacity: 0.8;">↗ +18.5% vs last year</div>
            </div>
            <div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; padding: 25px; border-radius: 12px; text-align: center;">
                <div style="font-size: 28px; font-weight: 700; margin-bottom: 8px;">₹28,15,000</div>
                <div style="opacity: 0.9; font-size: 16px;">Net Profit (YTD)</div>
                <div style="font-size: 14px; margin-top: 8px; opacity: 0.8;">↗ Margin: 22.4%</div>
            </div>
            <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white; padding: 25px; border-radius: 12px; text-align: center;">
                <div style="font-size: 28px; font-weight: 700; margin-bottom: 8px;">₹15,85,000</div>
                <div style="opacity: 0.9; font-size: 16px;">Outstanding Receivables</div>
                <div style="font-size: 14px; margin-top: 8px; opacity: 0.8;">↗ Average: 32 days</div>
            </div>
            <div style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); color: white; padding: 25px; border-radius: 12px; text-align: center;">
                ...
                <div style="font-size: 14px; margin-top: 8px; opacity: 0.8;">↗ +12 new this quarter</div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
            <div class="financial-dashboard">
                ...
                <div class="chart-placeholder">
                    <i class="fas fa-chart-line" style="font-size: 36px; color: #dee2e6; margin-right: 10px;"></i>
                    Revenue Trend Chart
                </div>
            </div>
            <div class="financial-dashboard">
                ...
                <div class="chart-placeholder">
                    <i class="fas fa-chart-pie" style="font-size: 36px; color: #dee2e6; margin-right: 10px;"></i>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="financial-dashboard">
                ...
                <div class="chart-placeholder">
                    <i class="fas fa-chart-bar" style="font-size: 36px; color: #dee2e6; margin-right: 10px;"></i>
            ...
            <div class="financial-dashboard">
                ...
                <div class="chart-placeholder">
                    <i class="fas fa-calendar-alt" style="font-size: 36px; color: #dee2e6; margin-right: 10px;"></i>

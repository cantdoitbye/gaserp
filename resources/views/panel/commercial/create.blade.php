...
<div class="main-container">
    ...
    <h1 class="page-title">Add New Commercial Job</h1>

    <div class="form-card">
        <div class="form-header">
            New Commercial Job Order Details
        </div>
        <div class="form-body">
                ...
                <div id="files-documents" class="tab-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="form-file-info">Accepted formats: PDF, JPG, Commercial (max: 5MB)</div>
                            @error('scan_copy')
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            <div class="form-file-info">Multiple files allowed. Accepted formats: PDF, DOC, DOCX, JPG, Commercial (max: 5MB each)</div>
            ...
            <form action="{{ route('commercial.store') }}" method="POST" enctype="multipart/form-data" onsubmit="debugFormSubmission(event)">
                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="commercial_type" id="commercial_type" class="form-control @error('commercial_type') is-invalid @enderror" onchange="loadMeasurementTypes()" required>
                                ...
                                @foreach(\App\Models\PngMeasurementType::getCommercialTypeOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('commercial_type') == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">Create Commercial Job</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function loadMeasurementTypes() {
        ...
        fetch(`{{ route('commercial.measurement-types.by-type') }}?commercial_type=${commercialType}`)

...
<div class="main-container">
    ...
    <h1 class="page-title">Edit Commercial Job</h1>

    <div class="form-card">
        <div class="form-header">
            Edit Commercial Job Order Details - #{{ $commercial->id }}
        </div>
        <div class="form-body">
            ...
            <form action="{{ route('commercial.update', $commercial->id) }}" method="POST" enctype="multipart/form-data" onsubmit="debugFormSubmission(event)">
                @csrf
                @method('PUT')
                ...
                <div id="basic-info" class="tab-content active">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="agreement_date" class="form-control @error('agreement_date') is-invalid @enderror" value="{{ old('agreement_date', $commercial->agreement_date ? $commercial->agreement_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_no" class="form-control @error('customer_no') is-invalid @enderror" value="{{ old('customer_no', $commercial->customer_no) }}">
                            @error('customer_no')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="service_order_no" class="form-control @error('service_order_no') is-invalid @enderror" value="{{ old('service_order_no', $commercial->service_order_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="application_no" class="form-control @error('application_no') is-invalid @enderror" value="{{ old('application_no', $commercial->application_no) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_name" class="form-control @error('customer_name') is-invalid @enderror" value="{{ old('customer_name', $commercial->customer_name) }}" required>
                            @error('customer_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_no" class="form-control @error('contact_no') is-invalid @enderror" value="{{ old('contact_no', $commercial->contact_no) }}">
                            @error('contact_no')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea name="address" rows="3" class="form-control @error('address') is-invalid @enderror">{{ old('address', $commercial->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea name="area" rows="2" class="form-control @error('area') is-invalid @enderror">{{ old('area', $commercial->area) }}</textarea>

                            {{-- <select name="area" class="form-control @error('area') is-invalid @enderror">
                                <option value="">Select Area</option>
                                @foreach(\App\Models\Commercial::getAreaOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('area', $commercial->area) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select> --}}
                        ...
                        <div class="form-group">
                            ...
                            <select name="scheme" class="form-control @error('scheme') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Commercial::getSchemeOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('scheme', $commercial->scheme) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div id="technical-details" class="tab-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="connections_status" class="form-control @error('connections_status') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Commercial::getConnectionsStatusOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('connections_status', $commercial->connections_status) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="plumber_name" class="form-control @error('plumber_name') is-invalid @enderror" value="{{ old('plumber_name', $commercial->plb_name) }}">
                            @error('plumber_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="plumbing_date" class="form-control @error('plumbing_date') is-invalid @enderror" value="{{ old('plumbing_date', $commercial->plb_date ? $commercial->plb_date->format('Y-m-d') : '') }}">
                            @error('plumbing_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="pdt_date" class="form-control @error('pdt_date') is-invalid @enderror" value="{{ old('pdt_date', $commercial->pdt_date ? $commercial->pdt_date->format('Y-m-d') : '') }}">
                            @error('pdt_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="pdt_witness_by" class="form-control @error('pdt_witness_by') is-invalid @enderror" value="{{ old('pdt_witness_by', $commercial->pdt_witness_by) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="ground_connections_date" class="form-control @error('ground_connections_date') is-invalid @enderror" value="{{ old('ground_connections_date', $commercial->ground_connections_date ? $commercial->ground_connections_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="ground_connections_witness_by" class="form-control @error('ground_connections_witness_by') is-invalid @enderror" value="{{ old('ground_connections_witness_by', $commercial->ground_connections_witness_by) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="isolation_name" class="form-control @error('isolation_name') is-invalid @enderror" value="{{ old('isolation_name', $commercial->isolation_name) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="mmt_date" class="form-control @error('mmt_date') is-invalid @enderror" value="{{ old('mmt_date', $commercial->mmt_date ? $commercial->mmt_date->format('Y-m-d') : '') }}">
                            @error('mmt_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mmt_witness_by" class="form-control @error('mmt_witness_by') is-invalid @enderror" value="{{ old('mmt_witness_by', $commercial->mmt_witness_by) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="conversion_technician_name" class="form-control @error('conversion_technician_name') is-invalid @enderror" value="{{ old('conversion_technician_name', $commercial->conversion_technician_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="conversion_date" class="form-control @error('conversion_date') is-invalid @enderror" value="{{ old('conversion_date', $commercial->conversion_date ? $commercial->conversion_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="conversion_status" class="form-control @error('conversion_status') is-invalid @enderror">
                                <option value="">Select Status</option>
                                @foreach(\App\Models\Commercial::getConversionStatusOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('conversion_status', $commercial->conversion_status) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="report_submission_date" class="form-control @error('report_submission_date') is-invalid @enderror" value="{{ old('report_submission_date', $commercial->report_submission_date ? $commercial->report_submission_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="meter_number" class="form-control @error('meter_number') is-invalid @enderror" value="{{ old('meter_number', $commercial->meter_number) }}">
                            @error('meter_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ra_bill_no" class="form-control @error('ra_bill_no') is-invalid @enderror" value="{{ old('ra_bill_no', $commercial->ra_bill_no) }}">
                            @error('ra_bill_no')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            <textarea name="remarks" rows="3" class="form-control @error('remarks') is-invalid @enderror">{{ old('remarks', $commercial->remarks) }}</textarea>
                            @error('remarks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div id="measurements" class="tab-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">Commercial Type <span class="required">*</span></label>
                            <select name="commercial_type" id="commercial_type" class="form-control @error('commercial_type') is-invalid @enderror" onchange="loadMeasurementTypes()" required>
                                <option value="">Select Commercial Type</option>
                                @foreach(\App\Models\PngMeasurementType::getCommercialTypeOptions() as $key => $value)
                                    <option value="{{ $key }}" {{ old('commercial_type', $commercial->commercial_type) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="commercial_measurement_type_id" id="measurement_type" class="form-control @error('commercial_measurement_type_id') is-invalid @enderror" onchange="loadMeasurementFields()" required>
                                <option value="">Select Measurement Type</option>
                                @if($commercial->measurementType)
                                    <option value="{{ $commercial->measurementType->id }}" selected>
                                        {{ $commercial->measurementType->name }}
                                    </option>
                                @endif
                            </select>
                            @error('commercial_measurement_type_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>

                    <div id="measurement-fields-container" style="{{ $commercial->measurements_data ? 'display: block;' : 'display: none;' }}">
                        <!-- Dynamic measurement fields will be loaded here -->
                        @if($commercial->measurements_data && $commercial->measurementType)
                            <div class="measurement-category" id="current-measurements-display">
                                ...
                                <div class="form-row">
                                    @php
                                        ...
                                        foreach($commercial->measurements_data as $key => $value) {
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <button type="button" class="btn btn-info" onclick="window.open('{{ route('commercial-measurement-types.index') }}', '_blank')">
                                <i class="fas fa-cog"></i> Manage Measurement Types
                            </button>
                            @if($commercial->measurements_data)
                ...
                <div id="files-documents" class="tab-content">
                    ...
                    <div class="documents-grid">
                        ...
                        <div class="document-section">
                            ...
                            @if($commercial->job_cards_paths && count($commercial->job_cards_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($commercial->job_cards_paths as $file)
                            ...
                            <div class="document-upload-area">
                                <input type="file" name="job_cards[]" id="job_cards" class="file-input" multiple accept=".pdf,.jpg,.jpeg,.commercial,.doc,.docx">
                            ...
                            <div class="document-info">
                                <small class="text-muted">Accepted formats: PDF, JPG, Commercial, DOC, DOCX (max: 5MB each)</small>
                            </div>
                        </div>
                        ...
                        <div class="document-section">
                            ...
                            @if($commercial->autocad_dwg_paths && count($commercial->autocad_dwg_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($commercial->autocad_dwg_paths as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                        ...
                        <div class="document-section">
                            ...
                            @if($commercial->site_visit_reports_paths && count($commercial->site_visit_reports_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($commercial->site_visit_reports_paths as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                            ...
                            <div class="document-upload-area">
                                <input type="file" name="site_visit_reports[]" id="site_visit_reports" class="file-input" multiple accept=".pdf,.jpg,.jpeg,.commercial,.doc,.docx">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            @if($commercial->scan_copy_path)
                                <div class="existing-file">
                                    <a href="{{ Storage::url($commercial->scan_copy_path) }}" target="_blank">View Current Scan Copy</a>
                                </div>
                            @endif
                            <input type="file" name="scan_copy" class="form-control-file @error('scan_copy') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.commercial">
                            <div class="form-file-info">Accepted formats: PDF, JPG, Commercial (max: 5MB) - Upload new file to replace existing</div>
                            @error('scan_copy')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if($commercial->certificate_path)
                                <div class="existing-file">
                                    <a href="{{ Storage::url($commercial->certificate_path) }}" target="_blank">View Current Certificate</a>
                                </div>
                            @endif
                            <input type="file" name="certificate" class="form-control-file @error('certificate') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.commercial">
                            <div class="form-file-info">Accepted formats: PDF, JPG, Commercial (max: 5MB) - Upload new file to replace existing</div>
                            @error('certificate')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            @if($commercial->other_documents_paths && count($commercial->other_documents_paths) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($commercial->other_documents_paths as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                            ...
                            @endif
                            <input type="file" name="other_documents[]" class="form-control-file @error('other_documents.*') is-invalid @enderror" multiple accept=".pdf,.jpg,.jpeg,.commercial,.doc,.docx">
                            <div class="form-file-info">Multiple files allowed. Accepted formats: PDF, DOC, DOCX, JPG, Commercial (max: 5MB each) - New files will be added to existing</div>
                    ...
                    <div class="form-row">
                        <div class="form-group-full">
                            ...
                            @if($commercial->additional_documents && count($commercial->additional_documents) > 0)
                                <div class="existing-files-list">
                                    <div class="existing-files-title">Existing Files:</div>
                                    @foreach($commercial->additional_documents as $file)
                                        <div class="existing-file">
                                            <a href="{{ Storage::url($file['path']) }}" target="_blank">{{ $file['name'] ?? 'File' }}</a>
                                            <small>{{ isset($file['size']) ? number_format($file['size']/1024, 2) . ' KB' : '' }}</small>
                                        </div>
                            ...
                            @endif
                            <input type="file" name="additional_documents[]" class="form-control-file @error('additional_documents.*') is-invalid @enderror" multiple accept=".pdf,.jpg,.jpeg,.commercial,.doc,.docx">
                            <div class="form-file-info">Multiple files allowed. Accepted formats: PDF, DOC, DOCX, JPG, Commercial (max: 5MB each) - New files will be added to existing</div>
                ...
                <div class="form-actions">
                    <a href="{{ route('commercial.index') }}" class="btn btn-secondary">Cancel</a>
                    <a href="{{ route('commercial.show', $commercial->id) }}" class="btn btn-info">View Details</a>
                    <button type="submit" class="btn btn-primary">Update Commercial Job</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    const existingMeasurements = @json($commercial->measurements_data ?? []);
    ...
    function loadMeasurementTypes() {
        ...
        const currentMeasurementTypeId = '{{ $commercial->commercial_measurement_type_id }}';
        ...
        // Fetch measurement types for selected Commercial type
        fetch(`{{ route('commercial-measurement-types.get-by-commercial-type') }}?commercial_type=${commercialType}`)
    ...
    function loadMeasurementFields() {
        ...
        fetch(`{{ url('admin/commercial-measurement-types') }}/${measurementTypeId}/fields`)
            .then(response => response.json())
            .then(data => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Load measurement types if Commercial type is already selected
        const commercialType = document.getElementById('commercial_type').value;
        if (commercialType) {
    ...
    function resetToCurrentMeasurements() {
        const container = document.getElementById('measurement-fields-container');
        const currentMeasurements = @json($commercial->measurements_data ?? []);

...
<div class="main-container">
    ...
    <h1 class="page-title">Edit PE/PNG Job</h1>

    <div class="form-card">
        <div class="form-header">
            Edit Job Order: {{ $pePng->job_order_number }}
        </div>
        <div class="form-body">
            <form action="{{ route('pe-png.update', $pePng) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="job_order_number" class="form-control @error('job_order_number') is-invalid @enderror" value="{{ old('job_order_number', $pePng->job_order_number) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" class="form-control @error('category') is-invalid @enderror" required>
                            ...
                            <option value="domestic" {{ old('category', $pePng->category) == 'domestic' ? 'selected' : '' }}>Domestic</option>
                            <option value="commercial" {{ old('category', $pePng->category) == 'commercial' ? 'selected' : '' }}>Commercial</option>
                            <option value="riser" {{ old('category', $pePng->category) == 'riser' ? 'selected' : '' }}>Riser</option>
                            <option value="gc" {{ old('category', $pePng->category) == 'gc' ? 'selected' : '' }}>GC</option>
                            <option value="conversion" {{ old('category', $pePng->category) == 'conversion' ? 'selected' : '' }}>Conversion</option>
                        </select>
                        @error('category')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="plumbing_date" class="form-control @error('plumbing_date') is-invalid @enderror" value="{{ old('plumbing_date', $pePng->plumbing_date->format('Y-m-d')) }}" required>
                        @error('plumbing_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="plumber_id" class="form-control @error('plumber_id') is-invalid @enderror" required>
                            ...
                            @foreach($plumbers as $plumber)
                                <option value="{{ $plumber->id }}" {{ old('plumber_id', $pePng->plumber_id) == $plumber->id ? 'selected' : '' }}>
                                    {{ $plumber->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="gc_date" class="form-control @error('gc_date') is-invalid @enderror" value="{{ old('gc_date', $pePng->gc_date ? $pePng->gc_date->format('Y-m-d') : '') }}">
                        @error('gc_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="mmt_date" class="form-control @error('mmt_date') is-invalid @enderror" value="{{ old('mmt_date', $pePng->mmt_date ? $pePng->mmt_date->format('Y-m-d') : '') }}">
                        @error('mmt_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="bill_ra_no" class="form-control @error('bill_ra_no') is-invalid @enderror" value="{{ old('bill_ra_no', $pePng->bill_ra_no) }}">
                        @error('bill_ra_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="plb_bill_status" class="form-control @error('plb_bill_status') is-invalid @enderror">
                            <option value="pending" {{ old('plb_bill_status', $pePng->plb_bill_status) == 'pending' ? 'selected' : '' }}>Pending</option>
                            <option value="processed" {{ old('plb_bill_status', $pePng->plb_bill_status) == 'processed' ? 'selected' : '' }}>Processed</option>
                            <option value="paid" {{ old('plb_bill_status', $pePng->plb_bill_status) == 'paid' ? 'selected' : '' }}>Paid</option>
                            <option value="locked" {{ old('plb_bill_status', $pePng->plb_bill_status) == 'locked' ? 'selected' : '' }}>Locked</option>
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="sla_days" class="form-control @error('sla_days') is-invalid @enderror" value="{{ old('sla_days', $pePng->sla_days) }}" min="0">
                        @error('sla_days')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pe_dpr" class="form-control @error('pe_dpr') is-invalid @enderror" value="{{ old('pe_dpr', $pePng->pe_dpr) }}">
                        @error('pe_dpr')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        @if($pePng->scan_copy_path)
                            <div class="mt-2">
                                <a href="{{ asset('storage/' . $pePng->scan_copy_path) }}" target="_blank" class="btn btn-sm btn-info">
                                    <i class="fas fa-file-alt"></i> View Current File
                                </a>
                            </div>
                        @endif
                        @error('scan_copy')
                    ...
                    <div class="form-group">
                        ...
                        @if($pePng->autocad_drawing_path)
                            <div class="mt-2">
                                <a href="{{ asset('storage/' . $pePng->autocad_drawing_path) }}" target="_blank" class="btn btn-sm btn-info">
                                    <i class="fas fa-file-alt"></i> View Current File
                                </a>
                            </div>
                        @endif
                ...
                <div class="form-row">
                    <div class="form-group-full">
                        ...
                        <textarea name="remarks" rows="4" class="form-control @error('remarks') is-invalid @enderror">{{ old('remarks', $pePng->remarks) }}</textarea>
                        @error('remarks')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group-full">
                        ...
                        <div id="site-visits-container" class="dynamic-list">
                            @if(is_array($pePng->site_visits) && count($pePng->site_visits) > 0)
                                @foreach($pePng->site_visits as $index => $visit)
                                    <div class="dynamic-item">
                                        <input type="date" name="site_visits[{{ $index }}][date]" class="form-control dynamic-field" value="{{ $visit['date'] ?? '' }}">
                                        <input type="text" name="site_visits[{{ $index }}][remarks]" class="form-control dynamic-field" placeholder="Visit Remarks" value="{{ $visit['remarks'] ?? '' }}">
                                        @if($index === 0)
                        ...
                        <div id="consumption-container" class="dynamic-list">
                            @if(is_array($pePng->consumption_details) && count($pePng->consumption_details) > 0)
                                @foreach($pePng->consumption_details as $index => $item)
                                    <div class="dynamic-item">
                                        <input type="text" name="consumption_details[{{ $index }}][item]" class="form-control dynamic-field" placeholder="Item" value="{{ $item['item'] ?? '' }}">
                                        <input type="number" name="consumption_details[{{ $index }}][quantity]" class="form-control dynamic-field" placeholder="Quantity" min="0" step="0.01" value="{{ $item['quantity'] ?? '' }}">
                                        <input type="text" name="consumption_details[{{ $index }}][unit]" class="form-control dynamic-field" placeholder="Unit" value="{{ $item['unit'] ?? '' }}">
                                        <input type="number" name="consumption_details[{{ $index }}][rate]" class="form-control dynamic-field" placeholder="Rate" min="0" step="0.01" value="{{ $item['rate'] ?? '' }}">
                                        @if($index === 0)

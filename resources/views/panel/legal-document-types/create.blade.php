...
<div class="form-container">
    <form action="{{ route('legal-document-types.store') }}" method="POST" class="document-type-form">
        @csrf
        ...
        <div class="form-body">
            ...
            <div class="form-group checkbox-group">
                <input type="checkbox" name="requires_expiry" id="requires_expiry" class="form-checkbox" value="1" {{ old('requires_expiry', 1) ? 'checked' : '' }}>
                <label for="requires_expiry">This document type requires expiry date</label>
            </div>
        </div>
        
        <div class="form-footer">
            <button type="submit" class="submit-btn">Save Document Type</button>

...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $('<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><label for="uploadFile" class="fw-500 f-25px text-black d-inline-block text-center position-absolute top-50 start-50 translate-middle">  <img src="'+globalSiteUrl+'/assets/img/icons/upload.png" alt="Upload" /> <span class="d-block">Upload Image</span> </label><button type="button" class="bg-transparent border-0 fw-500 f-25px text-black d-inline-block text-center position-absolute top-50 start-50 translate-middle w-100 h-100" id="btnimageuploadify"></button></div></div>');
...
//                        });
            ...
            button.mouseenter(function onMouseEnter(event) {
                button.css("background", "#ffffff").css("color", "#0077b0");
            }).mouseleave(function onMouseLeave() {
                button.css("background", "#0077b0").css("color", "#ffffff");
            });
